...
from tests.test_mock_helpers import create_mock_database_connection
...
class TestKnowledgeManagerAdapter:
    ...
    async def test_json_mode_initialization(self):
        ...
        # 應該已經同步初始化完成
        assert adapter._initialization_complete.is_set()
    ...
    async def test_database_mode_lazy_initialization(self):
        ...
        with (
            ...
            # 初始狀態：未初始化
            assert not adapter._initialization_complete.is_set()
