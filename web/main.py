...
@app.post("/api/grade-answer", response_class=JSONResponse)
...
@app.post("/api/generate-tagged-question", response_class=JSONResponse)
...
@app.post("/api/generate-question", response_class=JSONResponse)
...
@app.post("/api/preview-tagged-question", response_class=JSONResponse)
...
@app.post("/api/validate-tag-combination", response_class=JSONResponse)
...
@app.get("/api/tag-templates", response_class=JSONResponse)
